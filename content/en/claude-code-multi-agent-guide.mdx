...
In [section four of my advanced guide](/en/blog/claude-code-advanced-guide), I covered multi-agent parallelism in about 40 lines. But after using it extensively, this capability runs much deeper than I initially described.

You've set up your [CLAUDE.md](/en/blog/claude-md-guide), configured your [Hooks](/en/blog/claude-code-hooks-guide), and mastered [context management](/en/blog/claude-code-context-guide) — the next question is: **how do you get Claude to do multiple things at once?**
...
- [CLAUDE.md Writing Guide](/en/blog/claude-md-guide) — Share unified standards across all terminals
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Automate your multi-terminal workflow
- [Context Management Guide](/en/blog/claude-code-context-guide) — Manage each terminal's context effectively
