...
Throughout this series, CI/CD has kept popping up — the [testing guide](/en/blog/claude-code-testing-guide) touched on test automation, and the [Git guide](/en/blog/claude-code-git-guide) covered CI as part of the PR workflow. But no post has systematically addressed: **how to embed Claude Code into your CI/CD pipeline so it works even when you're not around**.
...
- [Claude Code Testing Workflow Guide](/en/blog/claude-code-testing-guide) — Test automation and CI integration
- [Claude Code Git Workflow Guide](/en/blog/claude-code-git-guide) — Git operations and PR workflows
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Deterministic local automation
- [The Complete CLAUDE.md Guide](/en/blog/claude-md-guide) — Project standards configuration
