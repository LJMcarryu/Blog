...
Throughout this series, we've covered everything from [CLAUDE.md](/en/blog/claude-md-guide) to [Hooks](/en/blog/claude-code-hooks-guide), from [MCP](/en/blog/claude-code-mcp-guide) to [Prompt techniques](/en/blog/claude-code-prompt-guide). But there's one topic that runs through every development workflow that we haven't dedicated a full article to — **Git workflows**.
...
This is one of Claude Code's most powerful work modes. As covered in the [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent-guide), the Agent tool supports an `isolation: "worktree"` parameter:
...
In the [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide), we covered how to create custom commands. Here's a practical code review command:
...
In the [CLAUDE.md Guide](/en/blog/claude-md-guide), we covered how to manage project conventions with CLAUDE.md. Git-related conventions are among the most important.
...
In the [Hooks Guide](/en/blog/claude-code-hooks-guide), we covered Claude Code's Hook system in detail. Here we focus on Git-specific Hook usage.
...
Configure permissions in [settings.json](/en/blog/claude-code-settings-guide):
...
- [CLAUDE.md Guide](/en/blog/claude-md-guide) — Encode Git conventions into project memory
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Intercept dangerous Git operations with Hooks
- [Context Management Guide](/en/blog/claude-code-context-guide) — Better context for more precise Git operations
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent-guide) — Worktree + multi-agent parallel development
- [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide) — Create custom /review commands
- [MCP Server Guide](/en/blog/claude-code-mcp-guide) — Extend Git integration with MCP
- [Prompt Techniques Guide](/en/blog/claude-code-prompt-guide) — Write better Git-related prompts
- [settings.json Guide](/en/blog/claude-code-settings-guide) — Configure permissions for Git operations
