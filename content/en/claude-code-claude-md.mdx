...
Even better: configure a [PostToolUse hook](/en/blog/claude-code-hooks) in settings.json to auto-format after every file write.
...
This is especially powerful combined with the [Custom Slash Commands Guide](/en/blog/claude-code-skills):
...
See the [settings.json Guide](/en/blog/claude-code-settings) Section 2 for details on session-level configuration.
...
- [Claude Code Advanced Guide](/en/blog/claude-code-overview) — The complete getting-started guide for Claude Code
- [The Complete settings.json Guide](/en/blog/claude-code-settings) — CLAUDE.md's partner: permissions, hooks, model, and environment config
- [Context Management Guide](/en/blog/claude-code-context) — Manage context effectively to make CLAUDE.md even more powerful
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks) — Automate formatting, linting, and validation with lifecycle hooks
- [Effective Prompt Guide](/en/blog/claude-code-prompt) — After configuring your project, writing good prompts is the next step
- [Custom Slash Commands Guide](/en/blog/claude-code-skills) — Turn common operations into reusable one-click commands
- [MCP Server Deep Dive](/en/blog/claude-code-mcp) — Extend Claude Code's capabilities with external tool servers
