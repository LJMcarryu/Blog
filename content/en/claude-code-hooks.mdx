...
In my [previous CLAUDE.md guide](/en/blog/claude-code-claude-md), I mentioned that CLAUDE.md tells Claude "what to do" while settings.json tells Claude "how to do it." And in the [advanced guide](/en/blog/claude-code-overview), I showed a few Hook examples briefly.
...
- [The Complete Guide to CLAUDE.md](/en/blog/claude-code-claude-md) — My deep dive into CLAUDE.md
- [Claude Code Advanced Guide](/en/blog/claude-code-overview) — Claude Code advanced tips roundup
