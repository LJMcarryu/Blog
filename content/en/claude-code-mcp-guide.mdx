...
In [section six of the advanced guide](/en/blog/claude-code-advanced-guide), I covered MCP basics in about 45 lines: configuring `settings.json`, listing 5 popular servers, and showing two usage scenarios.
...
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Deterministic automation
- [Context Management Guide](/en/blog/claude-code-context-guide) — Better context for more precise MCP tool calls
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent-guide) — MCP + multi-agent for team-level efficiency
- [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide) — Encapsulate common workflows
