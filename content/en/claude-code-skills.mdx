...
In [section five of the advanced guide](/en/blog/claude-code-overview), I covered custom Slash Commands in about 40 lines: create a `.claude/commands/` directory, write some `.md` files, use `$ARGUMENTS` for parameters.
...
Slash Commands and [Hooks](/en/blog/claude-code-hooks) are complementary:
...
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks) — Deterministic automation, complementary to Slash Commands
- [Context Management Guide](/en/blog/claude-code-context) — Manage context for more precise command execution
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent) — Commands + multi-terminal for team-level efficiency
