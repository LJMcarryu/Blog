...
In [section seven of the advanced guide](/en/blog/claude-code-advanced-guide), I covered four basic prompt tips in about 55 lines: task decomposition, adding constraints, pipe input, and iterative development.
...
Write project-level prompt conventions into [CLAUDE.md](/en/blog/claude-md-guide) so they apply automatically to every conversation:
...
Save frequently used prompt templates as [Slash Commands](/en/blog/claude-code-skills-guide):
...
- [Claude Code Advanced Guide](/en/blog/claude-code-advanced-guide) — Where prompt techniques were first introduced
- [The Complete CLAUDE.md Guide](/en/blog/claude-md-guide) — Write project-level prompt conventions into CLAUDE.md
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Automate repetitive operations with Hooks
- [Context Management Guide](/en/blog/claude-code-context-guide) — Manage context well to make prompts more effective
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent-guide) — Prompt strategies for multi-terminal collaboration
- [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide) — Turn prompt templates into one-click commands
- [MCP Server Deep Dive](/en/blog/claude-code-mcp-guide) — Extend Claude's capabilities with MCP