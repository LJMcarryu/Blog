...
In the [Complete CLAUDE.md Guide](/en/blog/claude-md-guide), I mentioned: **CLAUDE.md tells Claude "what to do," settings.json tells Claude "how to do it."**

Subsequent posts covered specific parts of settings.json: the [Hooks Guide](/en/blog/claude-code-hooks-guide) covered the `hooks` field, and the [MCP Guide](/en/blog/claude-code-mcp-guide) covered the `mcpServers` field. But settings.json as a unified system — its scope hierarchy, merge mechanics, and permission system — has never been covered.
...
| `hooks` | object | Lifecycle hooks | [Hooks Guide](/en/blog/claude-code-hooks-guide) |
| `mcpServers` | object | MCP server configuration | [MCP Guide](/en/blog/claude-code-mcp-guide) |
...
Hooks follow object merge rules. Hook arrays for the same lifecycle event (e.g., `PostToolUse`) are concatenated. See the [Hooks Guide](/en/blog/claude-code-hooks-guide) for detailed merge behavior.
...
- [Claude Code Advanced Guide](/en/blog/claude-code-advanced-guide) — The complete getting-started guide
- [The Complete CLAUDE.md Guide](/en/blog/claude-md-guide) — settings.json's partner, managing "what to do"
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Deep dive into the hooks field in settings.json
- [Context Management Guide](/en/blog/claude-code-context-guide) — Manage context well to make configuration more effective
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent-guide) — Configuration strategies for multi-terminal collaboration
- [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide) — Turn common operations into one-click commands
- [MCP Server Deep Dive](/en/blog/claude-code-mcp-guide) — Deep dive into the mcpServers field in settings.json
- [Effective Prompt Guide](/en/blog/claude-code-prompt-guide) — After configuring your environment, writing good prompts is the next step