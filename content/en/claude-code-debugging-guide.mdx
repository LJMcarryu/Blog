...
> For more on writing effective prompts when describing bugs, see the [Prompt Techniques Guide](/en/blog/claude-code-prompt-guide).
...
This automatically tests each bisect step. For more on git bisect, see the [Git Workflow Guide](/en/blog/claude-code-git-guide).
...
> For more on configuring Claude Code's environment, see the [Settings Guide](/en/blog/claude-code-settings-guide).
...
> For more on code optimization techniques, see the [Refactoring Guide](/en/blog/claude-code-refactoring-guide).
...
Your [CLAUDE.md](/en/blog/claude-md-guide) is the perfect place to encode debugging conventions. Here's a section you can add:
...
> For the full CLAUDE.md configuration guide, see the [CLAUDE.md Guide](/en/blog/claude-md-guide).
...
> For debugging failing tests, see Section 6 of the [Testing Guide](/en/blog/claude-code-testing-guide). For `git bisect`, see the [Git Workflow Guide](/en/blog/claude-code-git-guide).
...
- [Claude Code Advanced Guide](/en/blog/claude-code-advanced-guide) — Complete getting-started guide for Claude Code
- [Claude Code Testing Guide](/en/blog/claude-code-testing-guide) — Section 6 covers debugging failing tests in depth
- [Claude Code Refactoring Guide](/en/blog/claude-code-refactoring-guide) — Companion article: improving code that works
- [Claude Code Git Workflow Guide](/en/blog/claude-code-git-guide) — git bisect and regression tracking
- [CLAUDE.md Guide](/en/blog/claude-md-guide) — Encode debugging conventions into project memory
- [Claude Code Prompt Guide](/en/blog/claude-code-prompt-guide) — Write better bug descriptions for faster diagnosis
- [Claude Code Context Management Guide](/en/blog/claude-code-context-guide) — Provide the right context for debugging sessions
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks-guide) — Automate debugging workflows with Hooks
- [Claude Code MCP Guide](/en/blog/claude-code-mcp-guide) — Extend debugging capabilities with MCP servers
- [Claude Code Multi-Agent Guide](/en/blog/claude-code-multi-agent-guide) — Parallelize debugging across multiple agents
- [Claude Code Settings Guide](/en/blog/claude-code-settings-guide) — Configure permissions for debugging operations
- [Custom Slash Commands Guide](/en/blog/claude-code-skills-guide) — Create reusable debugging command templates
