...
- [The Complete History of LLMs: From RNN to GPT](/en/blog/llm-complete-guide) — If you want to systematically understand the technical principles behind LLMs
- [Claude Code Prompt Engineering Guide](/en/blog/claude-code-prompt-guide) — More prompt engineering techniques and practical examples