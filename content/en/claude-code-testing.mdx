...
Throughout this series, testing has come up repeatedly — the [Advanced Guide](/en/blog/claude-code-overview) covered vitest basics, the [Slash Commands Guide](/en/blog/claude-code-skills) showed `/test` command templates, and the [Git Guide](/en/blog/claude-code-git) included testing as part of the PR workflow. But we've never systematically covered: **how to build a complete testing workflow with Claude Code**.
...
In the [Slash Commands Guide](/en/blog/claude-code-skills), we already built a `/test` command template. Rather than repeating it here, let's cover advanced techniques.
...
> For more CLAUDE.md configuration tips, see the [Complete CLAUDE.md Guide](/en/blog/claude-code-claude-md).
...
> For more on CI/CD integration with Claude Code, see the CI/CD section in the [Git Workflow Guide](/en/blog/claude-code-git).
...
- [CLAUDE.md Guide](/en/blog/claude-code-claude-md) — Encode test conventions into project memory
- [Claude Code Hooks Guide](/en/blog/claude-code-hooks) — Automate testing workflows with Hooks
- [Context Management Guide](/en/blog/claude-code-context) — Better context for more precise test generation
- [Multi-Agent Parallelism Guide](/en/blog/claude-code-multi-agent) — Run tests in parallel with multiple agents
- [Custom Slash Commands Guide](/en/blog/claude-code-skills) — The /test command template in detail
- [MCP Server Guide](/en/blog/claude-code-mcp) — Extend testing capabilities with MCP
- [Prompt Techniques Guide](/en/blog/claude-code-prompt) — Write better testing-related prompts
- [settings.json Guide](/en/blog/claude-code-settings) — Configure permissions for test operations
- [Git Workflow Guide](/en/blog/claude-code-git) — Testing as part of the PR workflow
