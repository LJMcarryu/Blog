...
在这个系列里，CI/CD 其实一直在出现——[测试指南](/zh/blog/claude-code-testing-guide)里提过测试自动化，[Git 指南](/zh/blog/claude-code-git-guide)里把 CI 作为 PR 流程的一环。但从来没有一篇文章系统地讲过：**怎么把 Claude Code 嵌入 CI/CD 流水线，让它在你不在的时候也能干活**。
...
- [Claude Code 测试工作流指南](/zh/blog/claude-code-testing-guide) — 测试自动化与 CI 的配合
- [Claude Code Git 工作流指南](/zh/blog/claude-code-git-guide) — Git 操作与 PR 流程
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks-guide) — 本地自动化的确定性执行
- [CLAUDE.md 完全指南](/zh/blog/claude-md-guide) — 项目规范配置
