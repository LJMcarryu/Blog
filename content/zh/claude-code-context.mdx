...
在[进阶指南](/zh/blog/claude-code-overview)里，我用大约 40 行篇幅介绍了上下文管理的基本命令。但实际使用下来，我发现上下文管理是 Claude Code 中**最被低估、也最影响输出质量**的技能。

配好了 [CLAUDE.md](/zh/blog/claude-code-claude-md)，配好了 [Hooks](/zh/blog/claude-code-hooks)，如果上下文管理不到位，Claude 照样会给你离谱的回答。
...
3. **CLAUDE.md 始终在** — 它在每次对话开始时就被加载，所以写得精简很重要（参考 [CLAUDE.md 指南](/zh/blog/claude-code-claude-md)）

---

## 三、核心命令详解

[进阶指南](/zh/blog/claude-code-overview)里列了四个命令，这里展开讲每个命令的使用场景和最佳时机。
...
详细的 CLAUDE.md 写法参考 [CLAUDE.md 完全指南](/zh/blog/claude-code-claude-md)。
...
用 [Hooks](/zh/blog/claude-code-hooks) 自动处理重复性工作，减少对话来回：
...
- [Claude Code 进阶指南](/zh/blog/claude-code-overview) — 上下文管理最初的介绍在这里
- [CLAUDE.md 完全指南](/zh/blog/claude-code-claude-md) — 写好 CLAUDE.md 是上下文效率的基础
- [Claude Code Hooks 完全指南](/zh/blog/claude-code-hooks) — 用 Hooks 减少重复对话
