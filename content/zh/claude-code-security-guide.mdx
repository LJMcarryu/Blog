...
在这个系列里，安全话题其实一直在出现——[settings.json 指南](/zh/blog/claude-code-settings-guide)讲了权限系统的配置细节，[Hooks 指南](/zh/blog/claude-code-hooks-guide)讲了确定性执行拦截，[CI/CD 指南](/zh/blog/claude-code-cicd-guide)也提到了流水线中的安全实践。但从来没有一篇文章从**安全视角**系统性地串联所有防护机制。
...
> 权限系统的配置语法和字段细节请参考 [settings.json 完全指南](/zh/blog/claude-code-settings-guide)，本节聚焦安全策略。
...
> Hook 的事件类型、配置方式和匹配规则请参考 [Hooks 完全指南](/zh/blog/claude-code-hooks-guide)，本节聚焦安全拦截场景。
...
> CI/CD 集成的完整配置请参考 [CI/CD 指南](/zh/blog/claude-code-cicd-guide)，本节聚焦安全维度。
...
- [settings.json 完全指南](/zh/blog/claude-code-settings-guide) — 权限系统的配置细节
- [Hooks 完全指南](/zh/blog/claude-code-hooks-guide) — Hook 的事件类型和配置方式
- [CI/CD 集成指南](/zh/blog/claude-code-cicd-guide) — Headless 模式和 GitHub Actions
- [CLAUDE.md 完全指南](/zh/blog/claude-md-guide) — 项目知识和规则配置
- [Claude Code 进阶指南](/zh/blog/claude-code-advanced-guide) — 整体进阶用法
