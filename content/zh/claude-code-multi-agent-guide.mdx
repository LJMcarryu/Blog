...
在[进阶指南](/zh/blog/claude-code-advanced-guide)的第四节里，我用大约 40 行介绍了多 Agent 并行的基本概念。但实际用下来，这个能力远比我当时写的要深。

配好了 [CLAUDE.md](/zh/blog/claude-md-guide)，配好了 [Hooks](/zh/blog/claude-code-hooks-guide)，管好了[上下文](/zh/blog/claude-code-context-guide)——接下来的问题是：**怎么让 Claude 同时干多件事？**
...
- [CLAUDE.md 编写指南](/zh/blog/claude-md-guide) — 让所有终端共享统一规范
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks-guide) — 自动化你的多终端工作流
- [上下文管理指南](/zh/blog/claude-code-context-guide) — 管好每个终端的上下文
