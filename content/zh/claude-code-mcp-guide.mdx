...
在[进阶指南的第六节](/zh/blog/claude-code-advanced-guide)里，我用大约 45 行介绍了 MCP 的基本概念：配置 `settings.json`，列了 5 个常用 Server，给了两个使用场景。
...
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks-guide) — 确定性自动化
- [上下文管理指南](/zh/blog/claude-code-context-guide) — 管好上下文，让 MCP 工具调用更精准
- [多 Agent 并行指南](/zh/blog/claude-code-multi-agent-guide) — MCP + 多 Agent 实现团队级效率
- [自定义 Slash Commands 指南](/zh/blog/claude-code-skills-guide) — 封装常用工作流
