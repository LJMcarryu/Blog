...
在之前的系列文章里，我们从 [CLAUDE.md](/zh/blog/claude-code-claude-md) 讲到 [Hooks](/zh/blog/claude-code-hooks)，从 [MCP](/zh/blog/claude-code-mcp) 讲到 [Prompt 技巧](/zh/blog/claude-code-prompt)，但有一个贯穿所有开发流程的核心话题一直没有专门展开——**Git 工作流**。
...
这是 Claude Code 最强大的工作模式之一。在[多 Agent 并行指南](/zh/blog/claude-code-multi-agent)中我们介绍了 Agent 工具的 `isolation: "worktree"` 参数：
...
在[自定义 Slash Commands 指南](/zh/blog/claude-code-skills)中我们介绍了如何创建自定义命令。这里是一个实用的代码审查命令：
...
在 [CLAUDE.md 完全指南](/zh/blog/claude-code-claude-md)中我们讲了如何用 CLAUDE.md 管理项目规范。Git 相关的规范是其中最重要的部分之一。
...
在 [Hooks 指南](/zh/blog/claude-code-hooks)中我们详细介绍了 Claude Code 的 Hook 系统。这里聚焦 Git 相关的 Hook 用法。
...
在 [settings.json](/zh/blog/claude-code-settings) 中配置权限：
...
- [CLAUDE.md 完全指南](/zh/blog/claude-code-claude-md) — 把 Git 规范写进项目记忆
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks) — 用 Hooks 拦截危险 Git 操作
- [上下文管理指南](/zh/blog/claude-code-context) — 管好上下文，让 Git 操作更精准
- [多 Agent 并行指南](/zh/blog/claude-code-multi-agent) — Worktree + 多 Agent 的并行开发
- [自定义 Slash Commands 指南](/zh/blog/claude-code-skills) — 创建自定义 /review 命令
- [MCP Server 深度指南](/zh/blog/claude-code-mcp) — 用 MCP 扩展 Git 集成能力
- [高效 Prompt 指南](/zh/blog/claude-code-prompt) — 写好 Git 相关的 Prompt
- [settings.json 指南](/zh/blog/claude-code-settings) — 配置 Git 操作的权限控制
