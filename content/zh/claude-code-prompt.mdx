...
在[进阶指南](/zh/blog/claude-code-overview)的第七节里，我用大约 55 行介绍了四个基本的 Prompt 技巧：任务拆解、给约束条件、管道输入、迭代式开发。
...
把项目级的 prompt 规范写进 [CLAUDE.md](/zh/blog/claude-code-claude-md)，这样每次对话都自动生效：
...
把常用的 prompt 模板保存为 [Slash Commands](/zh/blog/claude-code-skills)：
...
- [Claude Code 进阶指南](/zh/blog/claude-code-overview) — Prompt 技巧最初的介绍在这里
- [CLAUDE.md 完全指南](/zh/blog/claude-code-claude-md) — 把项目级 Prompt 规范写进 CLAUDE.md
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks) — 用 Hooks 自动化重复操作
- [上下文管理指南](/zh/blog/claude-code-context) — 管好上下文，让 Prompt 更高效
- [多 Agent 并行指南](/zh/blog/claude-code-multi-agent) — 多终端协作的 Prompt 策略
- [自定义 Slash Commands 指南](/zh/blog/claude-code-skills) — 把 Prompt 模板变成一键命令
- [MCP Server 深度指南](/zh/blog/claude-code-mcp) — 用 MCP 扩展 Claude 的能力边界