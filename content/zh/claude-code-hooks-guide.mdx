...
在[上一篇 CLAUDE.md 指南](/zh/blog/claude-md-guide)里，我提到 CLAUDE.md 告诉 Claude "做什么"，settings.json 告诉 Claude "怎么做"。而在[进阶指南](/zh/blog/claude-code-advanced-guide)中，我也简单展示了几个 Hook 示例。
...
- [CLAUDE.md 完全指南](/zh/blog/claude-md-guide) — 本博客的 CLAUDE.md 深度解析
- [Claude Code 进阶指南](/zh/blog/claude-code-advanced-guide) — Claude Code 进阶技巧总结
