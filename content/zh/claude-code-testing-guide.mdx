...
在这个系列里，测试相关的内容其实一直在出现——[进阶指南](/zh/blog/claude-code-advanced-guide)里提过 vitest 基础，[Slash Commands 指南](/zh/blog/claude-code-skills-guide)里写了 `/test` 命令模板，[Git 指南](/zh/blog/claude-code-git-guide)里把测试作为 PR 流程的一环。但从来没有一篇文章系统地讲过：**怎么用 Claude Code 建立一套完整的测试工作流**。
...
在[自定义 Slash Commands 指南](/zh/blog/claude-code-skills-guide)里，我们已经写过 `/test` 命令模板。这里不重复那个模板，而是讲几个进阶技巧。
...
> 关于 CLAUDE.md 的更多配置技巧，参考 [CLAUDE.md 完全指南](/zh/blog/claude-md-guide)。
...
> 关于 CI/CD 与 Claude Code 的更多集成方式，参考 [Git 工作流指南](/zh/blog/claude-code-git-guide)的 CI/CD 章节。
...
- [CLAUDE.md 完全指南](/zh/blog/claude-md-guide) — 把测试规范写进项目记忆
- [Claude Code Hooks 指南](/zh/blog/claude-code-hooks-guide) — 用 Hooks 自动化测试流程
- [上下文管理指南](/zh/blog/claude-code-context-guide) — 管好上下文，让测试生成更精准
- [多 Agent 并行指南](/zh/blog/claude-code-multi-agent-guide) — 多 Agent 并行跑测试
- [自定义 Slash Commands 指南](/zh/blog/claude-code-skills-guide) — /test 命令模板详解
- [MCP Server 深度指南](/zh/blog/claude-code-mcp-guide) — 用 MCP 扩展测试能力
- [高效 Prompt 指南](/zh/blog/claude-code-prompt-guide) — 写好测试相关的 Prompt
- [settings.json 指南](/zh/blog/claude-code-settings-guide) — 配置测试相关的权限
- [Git 工作流指南](/zh/blog/claude-code-git-guide) — 测试作为 PR 流程的一环
